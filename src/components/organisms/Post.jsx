...
const PostContent = ({ posts, like, handleLike, onCommentClick, onDeletePost }) => {
    ...
    return (
        <div className='flex border-solid rounded-t border-2 border-gray-700 w-2/5 h-auto m-auto mt-10 flex-col relative'>
            <div className='flex justify-between relative w-full'>
                ...
                <Close onDelete={handleDelete} className='w-16 h-6 border-2 border-white mt-3'></Close>
            </div>
...
export const Post = ({ posts, toggleLikeStatus, toggleComments, onDeletePost }) => {
